"""Generate silly names by randomly combining names from two separate lists."""
import sys
import random
...
def main():
    ...
    first = ('Baby Oil', 'Bad News', 'Big Burps', "Bill 'Beenie-Weenie'",
             ...
             'Huckleberry', 'Huggy', 'Ignatious', 'Jimbo', "Joe 'Pottin Soil'",
             ...
             "Winston 'Jazz Hands'", '"Lunch Money"', 'Crab Meat', 'Worms')
    ...
    last = ('Appleyard', 'Bigmeat', 'Bloominshine', 'Boogerbottom',
            ...
            'Woolysocks', 'Weewax', 'Hoosenater', 'Rainwater')
    ...
    while True:
        ...
        try_again = input("\n\nTry again? (Press Enter if yes, 'n' to quit)\n")
